    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_modal_create_campaign")) && (new bootstrap.Modal(e), t = document.querySelector("#kt_modal_create_campaign_stepper"), a = document.querySelector("#kt_modal_create_campaign_stepper_form"), n = t.querySelector('[data-kt-stepper-action="submit"]'), o = t.querySelector('[data-kt-stepper-action="next"]'), (i = new KTStepper(t)).on("kt.stepper.changed", (function (e) {
                ...
                l.addTags(r), $("#kt_modal_create_campaign_datepicker").flatpickr({
                    altInput: !0,
                    enableTime: !0,
                    altFormat: "F j, Y H:i",
                ...
                [c, s].forEach((e => {
                    e.addEventListener("click", (t => {
                        e.classList.contains("active") || (c.classList.toggle("active"), s.classList.toggle("active"), s.classList.contains("active") ? d.nextElementSibling.classList.remove("d-none") : d.nextElementSibling.classList.add("d-none"))
                    }))
                }));
            ...
            }(), l.push(FormValidation.formValidation(a, {
                fields: {
                    campaign_name: {
                        validators: {
                            notEmpty: {
