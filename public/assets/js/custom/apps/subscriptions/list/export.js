        ...
        init: function () {
            t = document.querySelector("#kt_subscriptions_export_modal"), s = new bootstrap.Modal(t), r = document.querySelector("#kt_subscriptions_export_form"), e = r.querySelector("#kt_subscriptions_export_submit"), n = r.querySelector("#kt_subscriptions_export_cancel"), o = t.querySelector("#kt_subscriptions_export_close"), i = FormValidation.formValidation(r, {
                    ...
                    t.preventDefault(), i && i.validate().then((function (t) {
                        console.log("validated!"), "Valid" == t ? (e.setAttribute("data-kt-indicator", "on"), e.disabled = !0, setTimeout((function () {
                            e.removeAttribute("data-kt-indicator"), Swal.fire({
                                ...
                                t.isConfirmed && (s.hide(), e.disabled = !1)
                            }))
                        }), 2e3)) : Swal.fire({
                    ...
                    t.preventDefault(), Swal.fire({
                        ...
                        t.value ? (r.reset(), s.hide()) : "cancel" === t.dismiss && Swal.fire({
