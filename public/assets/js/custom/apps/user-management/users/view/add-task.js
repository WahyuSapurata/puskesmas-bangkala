...
var KTUsersAddTask = function () {
    ...
    return {
        init: function () {
            (() => {
            ...
            })(), document.querySelectorAll('[data-kt-menu-id="kt-users-tasks"]').forEach((t => {
                const e = t.querySelector('[data-kt-users-update-task-status="reset"]'),
                    n = t.querySelector('[data-kt-users-update-task-status="submit"]'),
                    o = t.querySelector('[data-kt-menu-id="kt-users-tasks-form"]');
                ...
                $(o.querySelector('[name="task_status"]')).on("change", (function () {
