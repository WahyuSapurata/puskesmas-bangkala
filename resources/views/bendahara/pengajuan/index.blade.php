                        ...
                        <tbody class="fw-semibold text-gray-600">
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td><a href="{{ url(Storage::url($item->file_pengajuan)) }}" target="_blank">Lihat
                                            File</a></td>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('pengajuan.kelola', $item->id) }}"
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
                            <form id="kt_modal_add_permission_form" class="form" action="{{ route('jenis.store') }}"
                                method="POST">
                                @csrf
                                <!--begin::Input group-->
                                <div class="fv-row mb-7">
                                    ...
                                    <label class="fs-6 fw-semibold form-label mb-2">
                                        ...
                                        <span class="ms-2" data-bs-toggle="popover" data-bs-trigger="hover"
                                            data-bs-html="true" data-bs-content="Nama jenis is required.">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" placeholder="Nama Jenis"
                                        name="nama_jenis" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
