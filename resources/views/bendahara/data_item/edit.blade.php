        ...
        <div class="container-fluid" id="kt_content_container">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <!--begin::Card title-->
                    <div class="card-title fs-3 fw-bold">Edit Data Alat</div>
                    <!--end::Card title-->
                </div>
                <!--end::Card header-->
                <!--begin::Form-->
                <form class="form" action="{{ route('alat.update', $alat->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <!--begin::Card body-->
                            ...
                            <div class="col-xl-9 fv-row">
                                <select name="jenis_id" class="form-control form-control-solid" id="jenis_id">
                                    ...
                                    @foreach ($jenis as $item)
                                        <option value="{{ $item->id }}" @selected($item->id == $alat->jenis_id)>
