                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
                    <thead>
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-300px">Nama Jenis</th>
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('jenis.edit', $item->id) }}" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3">
                                ...
                                <a href="{{ route('jenis.destroy', $item->id) }}" class="btn btn-icon btn-active-light-primary w-30px h-30px" data-kt-permissions-table-filter="delete_row" onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this data?')) {document.getElementById('delete-form-{{ $item->id }}').submit();}">
                                ...
                                <form id="delete-form-{{ $item->id }}" action="{{ route('jenis.destroy', $item->id) }}" method="POST" style="display: none;">
                                    @method('DELETE')
                                    @csrf
                                </form>
                            </td>
