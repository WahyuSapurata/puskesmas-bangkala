...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../"/>
		<title>Pengadaan Alat & Bahan</title>
		<meta charset="utf-8" />
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="d-flex flex-lg-row-fluid">
					...
					<div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
						<!--begin::Image-->
						<img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="assets/media/logo.png" alt="" />
						<img class="theme-dark-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="assets/media/logo.png" alt="" />
						<!--end::Image-->
						<!--begin::Title-->
						<h1 class="text-gray-800 fs-2qx fw-bold text-center mb-7">Pengadaan Alat & Bahan</h1>
						<!--end::Title-->
						<!--begin::Text-->
						<div class="text-gray-600 fs-base text-center fw-semibold">Sistem Informasi Pengadaan Alat Dan Bahan Habis Pakai di Laboratorium Kesehatan Pada Puskesmas Bangkala.</div>
						<!--end::Text-->
					</div>
					<!--end::Content-->
				</div>
							...
							<div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
								...
								<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="{{ route('login') }}" method="POST" action="{{ route('register') }}">
									...
									<div class="text-center mb-11">
										...
										<!--end::Title-->
										<!--begin::Subtitle-->
										<div class="text-gray-500 fw-semibold fs-6">Silahkan daftar!</div>
										<!--end::Subtitle=-->
									</div>
									<!--begin::Heading-->
									@if ($errors->any())
                                    ...
                                    <div class="fv-row mb-8">
                                        <div class="text-muted mb-2">Pilih Hak Akses (Staf/Bendahara)</div>
