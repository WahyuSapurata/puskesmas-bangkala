                ...
                <div class="aside-user mb-5 mb-lg-10" id="kt_aside_user">
                    ...
                    <div class="d-flex align-items-center flex-column">
                        ...
                        <div class="text-center">
                            <!--begin::Username-->
                            <a href="{{ route('dashboard') }}" class="text-gray-800 text-hover-primary fs-4 fw-bolder">{{ auth()->user()->name }}</a>
                            <!--end::Username-->
                            <!--begin::Description-->
                            <span class="text-gray-600 fw-semibold d-block fs-7 mb-1">{{ auth()->user()->email }}</span>
                            <!--end::Description-->
                        </div>
                        <!--end::Info-->
                    </div>
